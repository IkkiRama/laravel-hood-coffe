          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item has-treeview">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{url('/admin/kategori-artikel')}}" class="nav-link">
                            <i class="fa fa-tags nav-icon"></i>
            ...
            <li class="nav-item has-treeview">
                ...
                <p>
                    Affiliasi
                    {{-- disini nanti akan ada banyak kode" dari pelanggan, pelanggan daftar maka antan otomatis dapat kode/vocer berupa huruf acak --}}
                </p>
                </a>
            </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">@yield('judul_content')</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
