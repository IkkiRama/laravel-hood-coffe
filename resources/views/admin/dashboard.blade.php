...
@section('title', 'Dashboard | Hood Coffe Shop')
@section('judul_content', 'Dashboard')
@section('content')
    <!-- Info boxes -->
    <div class="row">
        ...
        <div class="info-box mb-3">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Pembelian Baru</span>
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                <span class="info-box-text">Income Pending</span>
                <span class="info-box-number">41,410</span>
                </div>
                <!-- /.info-box-content -->
            </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                <span class="info-box-text">Produk Dalam Keranjang</span>
                <span class="info-box-number">760</span>
                </div>
                <!-- /.info-box-content -->
            </div>
    ...
    <div class="row">
        ...
        <div class="info-box mb-3 bg-warning">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Kode Affiliasi</span>
            <span class="info-box-number">163,921</span>
            </div>
            <!-- /.info-box-content -->
        </div>
